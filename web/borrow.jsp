    ...
    <body>
                        ...
                        <div class="search_result">
                            ...
                            <div class="pageController" id="page-controller">
                                <div class="pageController1">
                                    <span class="btnPagePrev btnPage btnDisable"
                                        >Prev</span
                                    >
                                    <div class="listPage">
                                    ...
                                    <span class="btnPageNext btnPage"
                                        >Next</span
                                    >
                                </div>
        ...
        <script>
            ...
            function showPageController(type) {
                const totalPages = Math.ceil(data_books.length / itemsPerPage);
            ...
            const itemsPerPage = 1; // Số mục hiển thị trên mỗi trang
            ...
            function showDataBooks(inputValue) {
                ...
                if (data_books.length === 0) {
                    ...
                    const pageData = data_books.slice(startIndex, endIndex);
                        ...
                        element.addEventListener("click", function () {
                            if (element.dataset.checked == "false") {
                                ...
                                subjects[subjects.length] = {
                                    ...
                                    publisher: element.dataset.book_publisher,
                                    total: element.dataset.book_total_copies,
                                    remain: element.dataset
                                        .book_copies_available,
                                };

                                console.log(
                                    "Sau khi thêm" + JSON.stringify(subjects)
                                );
                                updateSelectedResult();
                            } else {
                                element.src = "./assets/img/select.svg";
            ...
            function createTableForm() {
                var form_table = document.querySelector(".form-content table");
            ...
            <tr>
                            ...
                            generateCodes("BK", subjects[i].id) +
                            `</td>
                                    </tr>`;
                    } else {
                        HTMLString += `<tr>
                ...
                form_table.insertAdjacentHTML("beforeend", HTMLString);
            }

            function generateCodes(prefix, num) {
                var res;
                const formattedNumber = num.toString().padStart(3, "0");
                res = prefix + formattedNumber;
                return res;
            }
        </script>
