...
<html lang="en">
    ...
    <body>
                ...
                <div class="body" style="margin-top: 18px">
                    <div class="breadcrumb">
                        ...
                        >
                            ...
                            <li>
                                <a href="index.html">PTIT Library</a>
                            </li>
                            <li>
                                <a href="#!">Tài liệu chuyên ngành</a>
                            </li>
            ...
            <div class="main-content">
                <div class="body">
                    <div class="section1">
                        ...
                        <ul>
                            <li><a href="cntt.html">Công Nghệ Thông Tin</a></li>
        ...
        <script src="https://stellarhold170nt.github.io/PTITLibrary/assets/js/script.js"></script>
        <script></script>
    </body>
</html>
