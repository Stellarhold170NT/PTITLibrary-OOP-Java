...
public class FilterAuth implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        String authURI = request.getContextPath() + "/";
        ...
        boolean loginRequest = request.getRequestURI().equals(authURI);
        boolean isUserServlet = request.getRequestURI().contains("home") 
                || request.getRequestURI().contains("login") || action.equals("register");
        ...
        // Định dạng thời gian
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm:ss"); // Sử dụng HH cho giờ 24
        String formattedTime = time.format(formatter);
        
        System.out.println(formattedTime);
        
        if (loggedIn ||loginRequest || isUserServlet || isStaticResource) {
            if (loggedIn) {
