...
public class UserDAO {
    ...
    public static User getUser(String username) {
     ...
     public static boolean checkAccount(User user) {
        ...
        String checkExistenceSQL = "SELECT COUNT(*) FROM users WHERE username = ?";
        
        try (var connnection = ds.getConnection()) {
            
            
            
            PreparedStatement psCheckExistence = connnection.prepareStatement(checkExistenceSQL);
            psCheckExistence.setString(1, user.getUsername());  // user.getUsername() là student_code
    ...
    public static boolean insertUser(User user) {
        ...
        String checkExistenceSQL = "SELECT COUNT(*) FROM students WHERE student_code = ? AND email = ?";
        ...
        try (var connnection = ds.getConnection()) {
                ...
                PreparedStatement psCheckExistence = connnection.prepareStatement(checkExistenceSQL);
                psCheckExistence.setString(1, user.getUsername());  // user.getUsername() là student_code
                psCheckExistence.setString(2, user.getEmail());
