...
import ptit.library.controller.NotificationDAO;
 ...
 * @author Admin
 */
@WebServlet(name = "NotificationServlet", urlPatterns = {"/noti"})
public class NotificationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Notification> lst = NotificationDAO.getNoti(student_id);
        Gson gson = new Gson();
